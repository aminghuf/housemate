...
SHOPPING_ITEM_ADDED_CHANNEL = "🛒 {adder} یه چیز به لیست خرید اضافه کرد: <b>{title}</b>"
SHOPPING_DM_LIST_HINT = "برای تیک زدن یه آیتم، روی دکمه‌ش بزن."
...
CLEANING_SECTION_MISSED_LINE = "{section}: ❗ انجام نشد ({name})"
...
CLEANING_STATUS_MISSED = "❗ انجام نشد"
CLEANING_NEXT_WEEK_BUTTON = "📅 نظافت هفته آینده"
CLEANING_NEXT_WEEK_HEADER = "📅 نظافت هفته آینده ({date}):"
CLEANING_NEXT_WEEK_SECTION_LINE = "   {section}: {name}"
CLEANING_NEXT_WEEK_NO_HOUSEMATES = "   کسی توی چرخه نیست"
CLEANING_NEXT_WEEK_PROJECTED_NOTE = "(هنوز پست نشده — روز نظافت اعلام میشه)"

# Daily nag for sections still not marked done
CLEANING_NAG_HEADER = "⏰ یادآوری: این بخش‌ها هنوز تیک نخوردن 👇"
CLEANING_NAG_LINE = "{section}: {mention}"
CLEANING_NAG_FOOTER = "اگه انجامش دادین روی «✅ تمیز کردم» بزنین."
...
ADMIN_CLEANING_NAG_TIME_SET = "⏰ ساعت یادآوری روزانه نظافت شد: {time}"
